...
func (bc *BookCreate) SetUUID(u uuid.UUID) *BookCreate {
...
func (bc *BookCreate) SetBackgroundColor(s string) *BookCreate {
	bc.mutation.SetBackgroundColor(s)
	return bc
}

// SetNillableBackgroundColor sets the "background_color" field if the given value is not nil.
func (bc *BookCreate) SetNillableBackgroundColor(s *string) *BookCreate {
	if s != nil {
		bc.SetBackgroundColor(*s)
	}
	return bc
}
...
func (bc *BookCreate) SetReport(s string) *BookCreate {
	bc.mutation.SetReport(s)
	return bc
}
...
func (bc *BookCreate) defaults() {
	...
	if _, ok := bc.mutation.BackgroundColor(); !ok {
		v := book.DefaultBackgroundColor
		bc.mutation.SetBackgroundColor(v)
	}
}
...
func (bc *BookCreate) check() error {
	...
	if _, ok := bc.mutation.BackgroundColor(); !ok {
		return &ValidationError{Name: "background_color", err: errors.New(`ent: missing required field "background_color"`)}
	}
	if _, ok := bc.mutation.Author(); !ok {
		return &ValidationError{Name: "author", err: errors.New(`ent: missing required field "author"`)}
	}
	if _, ok := bc.mutation.Report(); !ok {
		return &ValidationError{Name: "report", err: errors.New(`ent: missing required field "report"`)}
	}
...
func (bc *BookCreate) createSpec() (*Book, *sqlgraph.CreateSpec) {
	...
	if value, ok := bc.mutation.BackgroundColor(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := bc.mutation.Report(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
