...
func (*Book) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case book.FieldName, book.FieldBackgroundColor, book.FieldAuthor, book.FieldImageURL, book.FieldReport:
	...
	for i := range columns {
		...
		case book.FieldBackgroundColor:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				b.BackgroundColor = value.String
			}
